        ...
        return Mono.zip(
            ...
            .map(tuple -> {
                ...
                return Mono.zip(
                    ...
                    globe.path("enableTimeCapsule").asBoolean(true),
                    globe.path("enableInsight").asBoolean(true),
                    globe.path("cityCardHoverCarousel").asBoolean(true),
                    globe.path("enablePostcard").asBoolean(true),
